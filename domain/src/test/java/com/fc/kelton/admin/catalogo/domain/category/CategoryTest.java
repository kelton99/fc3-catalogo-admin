...
public class CategoryTest {
    ...
    @Test
    public void givenAnInvalidEmptyName_whenCallNewCategoryAndValidate_thenShouldRecieveError() {
    ...
    @Test
    public void givenAnInvalidNameLengthLessThan3_whenCallNewCategoryAndValidate_thenShouldRecieveError() {
        ...
        Assertions.assertEquals(expectedErrorCount, actualException.getErrors().size());
        Assertions.assertEquals("'name' must between 3 and 255", actualException.getErrors().get(0).message());
    }

    @Test
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldRecieveError() {
        final var expectedName = "AAAAAAAAAAAAAAAAAAAA".repeat(20);
        final var expectedErrorCount = 1;
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
    ...
    @Test
    public void givenAValidActivateCategory_whenCallDeactivate_thenReturnCategoryInactive() {
        final String expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = false;
    ...
    @Test
    public void givenAValidInactivateCategory_whenCallActivate_thenReturnCategoryActive() {
        final String expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
